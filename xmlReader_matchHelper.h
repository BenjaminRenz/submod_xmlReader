...
void init_matchlists(void){
    ...
    WM_IllegalChar=createWordMatchList(1,DlDuplicate(sizeof(uint32_t),CM_IllegalChar));
    WM_NonSpaceChar=createWordMatchList(1,DlDuplicate(sizeof(uint32_t),CM_NonSpaceChar));
